...
/**
 ...
 @param alertController The action sheet to be displayed.
 */
- (void)ugcController:(APUGCController *)ugcController preparedAlertController:(UIAlertController *)alertController;
