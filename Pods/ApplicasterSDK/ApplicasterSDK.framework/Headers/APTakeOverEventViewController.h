...
/**
 ...
 @param linkDictionary dictionary - compatible with APTimedWebViewController
 @param buttonDictionary dictionary - used to customize sync button background (masked element) and includes call to action text
...
/**
 Resets the view to its original postion
 */
