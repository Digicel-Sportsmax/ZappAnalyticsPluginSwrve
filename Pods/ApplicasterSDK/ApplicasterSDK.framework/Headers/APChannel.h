 ...
 */
@interface APChannel : APPurchasableItem <ZPPlayable, APChannelProtocol> {
	BOOL _playOnLoad;
...
/**
 * change the url of the stream url
 */
- (void)overrideStreamURL:(NSString *)overrideStreamURL;
/**
