...
/**
 Return Yes if model supports favorites
 @note: Some model type that conform protocol do not want to save as favorites
 */
 ...
 */
- (BOOL)addModelToFavorites:(NSObject <APFavoritesProtocol> *)model;
 ...
 *  @return BOOL value if succeeded.
 */
- (BOOL)removeModelFromFavorites:(NSObject <APFavoritesProtocol> *)model;
 ...
 */
- (BOOL)isLocalFavorite:(NSObject <APFavoritesProtocol> *)model;
