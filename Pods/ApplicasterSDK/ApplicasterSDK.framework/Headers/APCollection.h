...
extern NSString *const kAPCollectionPromotionNameKey;
extern NSString *const kAPCollectionSubPromotionNameKey;
 ...
 */
@interface APCollection : APModel <APContainerProtocol, ZPCollectionProtocol>
 ...
 */
@property (nonatomic, weak, readonly) NSString *screenType;
