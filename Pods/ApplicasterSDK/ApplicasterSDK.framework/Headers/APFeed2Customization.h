...
/*
 Fetch new customization colors and asset from server - with completion
 @param isDemo - boolean decides if to return the preview customizations
 @param success - optional completion block to be called on success
 @param failure - optional completion block to be called on failure with the relevant networking error
 **/
- (void)refreshCustomization:(BOOL)isDemo
...
/*
 Get a letter and retun a UIColor object with the correct color and make it darker
