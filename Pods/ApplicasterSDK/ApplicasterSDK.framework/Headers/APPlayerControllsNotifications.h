...
extern NSString *const APPlayableItemWillStartPlaying;                  /**< Called when player controller starts playing playable item */
...
extern NSString *const APPlayerControllerPlayerInterruptionNotification;        // During OS interruption
...
extern NSString *const kAPPlayerControllerPlayingItemID;                    // Contains the current item's ID property
...
extern NSString *const kAPPlayerControllerPlayingItemSeasonName;            // Contains the current item's season name.
extern NSString *const kAPPlayerControllerPlayingItemExternalID;            // Contains the current item's external id.
extern NSString *const kAPPlayerControllerPlayingItemSourceFile;            // Contains the current item's source file.
/**
...
extern NSString *const APApplicasterPlayerForwardPlaybackNotification; /** Forward */
extern NSString *const APApplicasterPlayerBackwardPlaybackNotification; /** Backward */
...
/**
 Post this notification if you want to delete the current playing item from hqme cache.
 */
