...
/**
 ...
 @param startDate - The minimum time. The a program would be returned if it's end time is after the start time.
 @param endDate - The local maximum time, a program would be returned if it's start time is before the end time.
