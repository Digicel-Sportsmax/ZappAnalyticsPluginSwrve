...
/**
 ...
 @param userNotificationSettings The user’s specified notification settings for your app. The settings in this object may be different than the ones you originally requested.
 */
- (void)didRegisterUserNotificationSettings:(UIUserNotificationSettings *)userNotificationSettings;
/**
...
- (void)sendTapNotificationEvent:(NSDictionary *)parameters;
