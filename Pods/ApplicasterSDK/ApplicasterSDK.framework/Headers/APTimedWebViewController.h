 ...
 */
@interface APTimedWebViewController : UIViewController <WKNavigationDelegate, WKUIDelegate, WKScriptMessageHandler, ZPAnalyticsScreenProtocol> {
	//UI
 ...
 */
@property (nonatomic, weak) id<APTimedWebViewControllerDelegate> delegate;
...
/**
 Try to go back in webview navigation.
*/
- (BOOL)tryToGoBack;
