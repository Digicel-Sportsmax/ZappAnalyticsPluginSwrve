...
@interface APCircleProgressIndicator : UIView
...
/**
 ...
 hideEmptyProgressBar The defualt value is NO. Set YES when you'd like to hide the empty progress.
 */
@property (nonatomic) BOOL hideEmptyProgressBar;

/**
 If you'd like to design a progress bar in shape of pie.
 pieShapeProgressBar The defualt value is NO. Set YES when you'd like to design a progress bar in shape of pie.
 */
