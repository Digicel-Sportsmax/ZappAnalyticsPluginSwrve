...
@class APSHMEntity;
@interface APSHMAction : NSObject
 ...
 */
-(void)performActionWithFields:(NSDictionary *)fields andCompletion:(void (^)(NSError *, APSHMEntity *))block;
 ...
 */
-(void)performActionWithCompletion:(void (^)(NSError *, APSHMEntity *))block;
@end
