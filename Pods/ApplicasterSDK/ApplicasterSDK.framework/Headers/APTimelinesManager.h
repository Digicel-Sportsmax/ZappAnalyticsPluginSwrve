...
/**
 Open specific feed (by timelineID) with Live channel from URLScheme (APSchemeHandler)
 */
- (void)presentFeedWithTimelineID:(NSString *)timelineID andChannelID:(NSString *)channelID completionHandler:(void (^)(BOOL success))completion;

/**
 Open specific feed (by timelineID) with Live channel from URLScheme (APSchemeHandler)
 @property timelineID - timeline ID to present
 @property channelID - Channel ID to present on top of feed
 @property newFeed - True if to present new RN feed , false otherwise
 @property completion - completion block on the presentation attempt.
 */
- (void)presentFeedWithTimelineID:(NSMutableDictionary *)params newFeed:(BOOL)newFeed completionHandler:(void (^)(BOOL success))completion;
