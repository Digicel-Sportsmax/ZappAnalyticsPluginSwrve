...
static NSString *const APInstagramClientLoginCanceled = @"APInstagramClientLoginCanceled";
...
/**
 Login to Instagram using an APTimedWebView.
 Unless the scheme is an internal URL scheme (No longer allowed on new apps in Instagram) - use this function.
 
 This will use http://www.applicaster.com/instagram as the prefix to the login - as currently Instagram requires a valid URL.
 */
- (void)loginUsingWebView;
...
/**
 ...
 @param success - Success block returning Pagination Info and array of media items
