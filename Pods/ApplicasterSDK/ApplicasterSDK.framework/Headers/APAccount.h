 ...
 */
@property (strong, readonly) NSArray<APBroadcaster *> *broadcasters;
 ...
 */
@property (nonatomic, readonly) ZPPreloadURLType preloadUrlType;
...
/**
 Push engine used - Currently either Urban Airship
 */
...
/**
 Returns the broadcaster model with the given id.
 */
- (APBroadcaster *)broadcasterByID:(NSString *)broadcasterID;
