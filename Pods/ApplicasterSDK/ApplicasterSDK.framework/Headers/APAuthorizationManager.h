...
/**
 ...
 @param showErrorMessage - If YES, an alert should be displayed informing the user of the cancellation.
 */
- (void)didCancelAuthorization:(BOOL)showErrorMessage;

/**
 This method should be called if the user exits the SSO screen / cancels the process.
 */
- (void)didCancelAuthorization DEPRECATED_MSG_ATTRIBUTE("Use didCancelAuthorization: instead");
...
/**
 The authorization client which is currently processing.
 */
@property (nonatomic, strong) id<APAuthorizationClient> currentAuthClient;
...
/**
 ...
 @param authorizationProvider - The authorization provider which will be used for the authorization.
...
- (void)startAuthorizationWithProvider:(APAuthorizationProvider *)authorizationProvider
                           purchasable:(id<ZPPurchasableItemProtocol>)purchasable
