...
/**
 Hashtag list
 */
@property (nonatomic, readonly, strong) NSArray *instagramHashTagList;

/**
 Instagram pull query
 */
@property (nonatomic, readonly, strong) NSArray *instagramPullQuery;

/**
 Instagram pull query type
 */
@property (nonatomic, readonly, strong) NSString *instagramPullQueryType;
