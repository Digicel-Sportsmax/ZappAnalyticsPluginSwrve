...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/ApplicasterSDK/ApplicasterSDK.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SwrveSDKCommon/SwrveSDKCommon.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ZappAnalyticsPluginSwrvePlugin/ZappAnalyticsPluginSwrvePlugin.framework"
